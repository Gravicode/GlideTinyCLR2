...
namespace TinyCLR2.Glide
{
    public class BitmapHelper : IDisposable
    {
        ...
        internal void SetPixel(int x, int y, GHI.Glide.Media.Color color)
        {
        ...
        internal void DrawEllipse(
          GHI.Glide.Media.Color color1,
          ushort thickness,
          int v1,
          int v2,
          int xRadius,
          int yRadius,
          GHI.Glide.Media.Color color2,
          int v3,
          int v4,
          GHI.Glide.Media.Color color3,
          int v5,
          int v6,
          ushort v7)
        {
        ...
        internal void DrawRectangle(
          GHI.Glide.Media.Color outlineColor,
        ...
        internal void DrawLine(GHI.Glide.Media.Color color, int v, int ix1, int y1, int ix2, int y2)
        {
            this.surface.DrawLine(color.ToNativeColor(), v, ix1, y1, ix2, y2);
        }

        internal void DrawText(string text, Font font, GHI.Glide.Media.Color color, int v1, int v2)
        {
